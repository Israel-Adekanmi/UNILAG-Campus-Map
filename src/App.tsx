...
const graph: Record<string, Record<string, number>> = {
  ...
  'Faculty of Art': { 'Faculty of Law': 2, 'Ecobank': 4, 'Fire Station': 3, },
  'Mariere Hostel': { 'Faculty of Engineering': 4, 'Cab Car Park': 2,},
  'GT Bank': { 'Car Cab Park': 2, 'Zenith Bank': 2, 'DSA Office': 2 },
  ...
  'Faculty of Mass Com': { 'Moremi Hostel': 4, 'CITS': 3, 'Ecobank': 4, 'Fire Station': 2 },
  ...
  'Fire Station': { 'Faculty of Art': 3, 'Eni Njoku Hostel': 3, 'CITS': 2, 'Faculty of Mass Com': 2 },
  'Cab Car Park': { 'Moremi Hostel': 2, 'Mariere Hostel': 2, 'GT Bank': 2, },
  'Shuttle Car Park': { 'CITS': 1, 'Eni Njoku Hostel': 2, 'New Hall': 3 },
  'Staff School': { 'DSA Office': 2, 'Jaja Hostel': 3, 'Unilag Medical Center': 3 },
  'DSA Office': { 'Staff School': 2, 'GT Bank': 2, 'Moremi Hostel': 2 },
};
